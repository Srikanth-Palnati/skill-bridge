                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">SkillBridge</div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 text-sm">
                                    SkillBridge is an learning platform designed to empower students with practical, career-focused courses.
                                    Learn from industry experts and gain real-world skills at your own pace.
                                    Start your journey with SkillBridge and bridge the gap to your dream career.
                                </div>
                            </div>
                        </div>
                        <!-- 
